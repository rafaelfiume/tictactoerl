...
prints_board_test() ->
    Board = #board{top_left = "X", center = "O", bottom_center ="X"},
...
wins_with_a__vertical__row_in_the_right_test() ->
    Board = #board{top_right = "X", mid_right = "X", bottom_right ="X"},
...
wins_with_a__horizontal__row_in_the_top_test() ->
    Board = #board{top_left = "O", top_center = "O", top_right ="O"},
...
wins_with_a__horizontal__row_in_the_center_test() ->
    Board = #board{mid_left = "O", center = "O", mid_right ="O"},
...
wins_with_a__horizontal__row_in_the_bottom_test() ->
    Board = #board{bottom_left = "O", bottom_center = "O", bottom_right ="O"},
...
mark_position_when__topcenter__is_available_test() ->
    ...
    Free = true,
    CurrentBoard = #board{top_center = "X"}.
...
mark_position_when__topright__is_available_test() ->
    ...
    Free = true,
    CurrentBoard = #board{top_right = "X"}.
...
mark_position_when__midright__is_available_test() ->
    ...
    Free = true,
    CurrentBoard = #board{mid_right = "X"}.
...
mark_position_when__bottomleft__is_available_test() ->
    ...
    Free = true,
    CurrentBoard = #board{bottom_left = "X"}.
...
mark_position_when__bottomcenter__is_available_test() ->
    ...
    Free = true,
    CurrentBoard = #board{bottom_center = "X"}.

mark_position_when__bottomright__is_available_test() ->
    PreviousBoad = #board{top_left = "X", center = "O", top_right = "X"},

    {Free, CurrentBoard} = board:mark_position_if_available(PreviousBoad, 9, "O"),

    Free = true,
    CurrentBoard = #board{top_left = "X", center = "O", top_right = "X", bottom_right = "O"}.
